      ...
      >
        {!task && !loading && (
          <div className="text-center space-y-4">
            <h2 className="text-xl font-bold text-zinc-900 dark:text-white">Track Your Order</h2>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-12 space-y-4">
            ...
            <p className="text-sm font-medium text-zinc-500 animate-pulse uppercase tracking-widest">Fetching order details...</p>
          </div>
        )}
